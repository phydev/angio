...
module global_m  
  ...
  type sec_mesh_t
     real :: phi
      ...
      ! mesh variables
      integer, public, allocatable :: lxyz(:,:), lxyz_inv(:,:,:),  grid_cell_domain(:)
      integer, public :: Lsize(1:3), boundary_points
      integer, public :: np, np_part, ip, n_max_tipc
      real, public, allocatable :: gg(:,:), lapl(:), f(:)
      ...
      integer, public :: n_source = 0, source_max, n_source_initial
      ...
      integer, public :: np_vegf_s, np_tip_s, np_tip_all, n_tipcell = 0
